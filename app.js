...
function fallbackAvatar(name = "?") {
  ...
  return `data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='64' height='64'><rect width='64' height='64' fill='%23000000'/><text x='50%25' y='54%25' font-size='30' fill='%2300abfc' text-anchor='middle' dominant-baseline='middle' font-family='sans-serif'>${ch}</text></svg>`;
}
